        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a class="text-gray-800 dark:text-gray-200" href="{{ route('home') }}">
            ...
            <div class="-me-2 flex items-center sm:hidden">
                <button
                    ...
                    text-gray-400 dark:text-gray-500 hover:text-gray-500 dark:hover:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-900
